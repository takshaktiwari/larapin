    ...
    <div class="container-fluid">
    	...
    	<div class="row align-items-center">
    	    <div class="col-sm-6">
    	        <div class="page-title-box">
    	            <h4 class="font-size-18">Edit Pincode</h4>
		...
		<div class="row">
			<div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('admin/pincode/update') }}" method="POST" class="p-sm-3 p-0">
                            @csrf
                            <div class="form-group">
                                ...
                                <select name="country_id" id="country_id" class="form-control" required>
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}" {{ selected($pincode->country_id, $country->id) }}>
                                            {{ $country->country }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="state_id" id="state_id" class="form-control" required>
                                    ...
                                    @foreach($states as $state)
                                        <option value="{{ $state->id }}" {{ selected($pincode->state_id, $state->id) }}>
                                            {{ $state->state }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="district_id" id="district_id" class="form-control" required>
                                    ...
                                    @foreach($districts as $district)
                                        <option value="{{ $district->id }}" {{ selected($pincode->district_id, $district->id) }}>
                                            {{ $district->district }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pincode" required class="form-control"  value="{{ $pincode->pincode }}">
                            </div>
